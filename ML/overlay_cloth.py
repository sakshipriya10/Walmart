...
try:
    ...
    fit_type = sys.argv[4] if len(sys.argv) > 4 else "medium"  # optional override
    ...
    # Fit control
    fit_scale = 1.6  # medium
    if fit_type == "tight":
        fit_scale = 1.4
    elif fit_type == "loose":
        fit_scale = 1.8

    cloth_width = int(shoulder_width * fit_scale)
    ...
    user_img = cv2.GaussianBlur(user_img, (3, 3), 0)
